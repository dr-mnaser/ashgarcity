...
# -------------- SETTINGS --------------
page_title = "Ashgarcity Appartment"
...
six_months_ago = today - datetime.timedelta(days=365)
                ...
                if submitted:
                    try:
                        ...
                        if len(items) > 0:
                            ...
                            #dates = [item["date"].strftime('%Y-%m-%d') for item in items]
                    ...
                    if len(dates) > 0:
                        ...
                        # Proceed with calculating totals
                        total_income = df[df['Transaction'] == 'Income']['Value'].sum()
                        #zakah = math.ceil(0.025 * total_income)
                        total_expense = df[df['Transaction'] == 'Expense']['Value'].sum()
                        remaining_budget = total_income - total_expense
                        
                        # Display the metrics
                        col4.metric("Income", f"£{total_income}")
                        col6.metric("Expenses", f"£{total_expense}")
